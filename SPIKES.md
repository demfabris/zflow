...
| C | Does a uinput virtual touchpad trigger real GNOME gestures? | 1 | PARTIAL: GNOME fires the overview from synthetic 3-finger swipes (ID_INPUT_TOUCHPAD accepted), but the transition snaps instead of tracking 1:1; diagnostic next step in RESULT.md |
